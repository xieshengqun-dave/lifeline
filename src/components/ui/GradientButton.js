...
// Primary full-width CTA — gradient fill, trailing arrow by default. Used
// everywhere the design shows the teal gradient button (spec: height
// 58-64px, radius 17-18, primary shadow).
